    ...
    <nav className="fixed bottom-2 lg:bottom-8 w-full overflow-hidden z-50">
      <div className="container mx-auto">
        <div className="w-full bg-black/20 h-[96px] backdrop-blur-2xl rounded-full max-w-[460px] mx-auto px-5 flex justify-between text-2xl text-white/50 items-center">
          ...
          >
            <BiHomeAlt className="hover:scale-150 transition" />
          </Link>
          <Link
            to="about"
            activeClass="active"
            ...
            className="cursor-pointer w-[60px] h-[60px] flex items-center justify-center"
          >
            <BiUser className="hover:scale-150 transition" />
          </Link>
          <Link
            to="service"
            activeClass="active"
            ...
            className="cursor-pointer w-[60px] h-[60px] flex items-center justify-center"
          >
            <BsClipboardData className="hover:scale-150 transition" />
          </Link>
          <Link
            to="work"
            activeClass="active"
            ...
            className="cursor-pointer w-[60px] h-[60px] flex items-center justify-center"
          >
            <BsBriefcase className="hover:scale-150 transition" />
          </Link>
        </div>
      </div>
    </nav>
